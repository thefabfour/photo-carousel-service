...
import PhotoItem from '../client/src/components/PhotoItem/PhotoItem'

describe('PhotoItem component', () => {
  // const server = setupServer(

  //   rest.get('/api/home/30506101/photos', (req, res, ctx) => {
  ...
  // it('photo should load', () => {
  //   render(<PhotoItem photo={photos[4]} setSelectedPhoto={()=>{}} setModalOpen={()=>{}} />);
